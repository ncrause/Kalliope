...
<html>
	...
	<body>
		...
		<div id="edit-fontVariant" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:fontVariantInstance, action:'update']" method="PUT"  enctype="multipart/form-data">
				<g:hiddenField name="version" value="${fontVariantInstance?.version}" />
				<fieldset class="form">

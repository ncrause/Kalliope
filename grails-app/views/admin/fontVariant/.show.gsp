...
<html>
    ...
    <body>
        ...
        <div id="show-fontVariant" class="content scaffold-show" role="main">
            ...
            <f:display bean="fontVariant" />
            <g:form resource="${this.fontVariant}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.fontVariant}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
